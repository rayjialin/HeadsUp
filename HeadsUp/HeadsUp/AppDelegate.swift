...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        geofireRef.child("Users").child(uuid).updateChildValues(["agreedToMeet": false])
        geofireRef.child("Users").child(uuid).updateChildValues(["agreedToStart": false])
        geofireRef.child("Users").child(uuid).updateChildValues(["showPhoneNumber": false])
